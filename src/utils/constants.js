export const STAGES = [
    ...
    { level: 2, cols: 12, rows: 12, mines: 20, cards: 6,  jamRate: 0.05 },
    { level: 3, cols: 15, rows: 15, mines: 35, cards: 8,  jamRate: 0.10 },
    { level: 4, cols: 18, rows: 18, mines: 55, cards: 12, jamRate: 0.15 },
    { level: 5, cols: 22, rows: 22, mines: 85, cards: 16, jamRate: 0.20 },
];
